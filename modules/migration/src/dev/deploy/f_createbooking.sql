...
CREATE OR REPLACE FUNCTION createbooking(email text, start_date timestamp with time zone, end_date timestamp with time zone, guests integer, firstname text, lastname text, payment_type text, phone text, user_id integer, y_id integer, additionals text) RETURNS boolean
